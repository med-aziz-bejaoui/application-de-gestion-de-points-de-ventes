				...
				if (actionProd.equals("vendre_produit")) {
					...
					do {
						...
						test_ajout_produit = dao.ajouter_produit(values.get(0).toString(),
								...
								Integer.parseInt(values.get(3).toString()), Integer.parseInt(values.get(4).toString()));
					...
					do {
						...
						if (validation.equals("valider")) {
							...
							test_modification_produit = Produit2.modifierproduit(Set_values.get(0).toString(),
									Integer.parseInt(Set_values.get(1).toString()),
					...
					/*
					 * inputStream.close(); outputStream.close(); s.close();
					 */
				}
			}
