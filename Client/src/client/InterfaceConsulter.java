...
public class InterfaceConsulter extends JFrame {
	...
	public InterfaceConsulter() {
		...
		JLabel lblVendreProduit = new JLabel("Consulter Un Produit");
	...
	public void setLabelsConsulte() {
		
		intituleproduit.setEnabled(false);
		
		prixunitaire.setEnabled(false);
		
		tauxremise.setEnabled(false);
		
		quantitedispo.setEnabled(false);
		
		
	}
	public void setLabelsConsulter(String string, int parseInt, int parseInt2, int parseInt3) {
